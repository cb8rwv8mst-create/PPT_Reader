...
export const UploadPage: React.FC<Props> = ({ onUploadSuccess }) => {
  ...
  return (
    <div style={{ 
      ...
      position: 'relative',
      // 🌟 核心改进：引入微软 Fluent/苹果发布会级别的 3D 高奢流体壁纸，配合黄金比例暗光遮罩，彻底告别单调纯色与廉价感
      backgroundImage: `
      ...
      {/* 🔮 主体卡片：高透光晶莹水晶舱（完美衬托背景流光的色彩） */}
      <div style={{ 
        background: 'rgba(255, 255, 255, 0.03)', 
        padding: '55px 50px', 
        borderRadius: '28px', 
        // 细腻的多重弥散阴影与高级柔焦，让卡片像一块悬浮的厚玻璃
